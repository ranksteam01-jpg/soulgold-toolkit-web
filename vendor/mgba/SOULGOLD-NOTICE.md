...
2026-09-24 SDK extension: optional accelerated audio using grouped stereo sample averaging/decimation, with queue flushing on speed or audio-mode changes. Pitch follows speed. Muted fast-forward remains the default. Human-readable modified source is mgba.sdk.js; WASM and savestate layout are unchanged.
